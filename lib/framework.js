...
var _expect = function(passed, msg, options){
    ...
    if(passed){
        ...
        write('<div class="console-passed">' + successMsg + '</div>', true)
        correct++
    } else {
        ...
        if (options.extraCredit) {
            ...
            write("<div class='console-missed'>" + msg + "</div>", true)
            incorrect++
        }
        else{
            write("<div class='console-failed'>Test Failed: " + msg + "</div>", true)
...
var Test = {
    ...
    describe: function(msg, fn) {
        try{
            ...
            logCall('describe')
            describing = true
            html.push('<div class="console-describe"><h6>');
    ...
    it: function(msg, fn) {
        try{
            logCall('it');
            html.push('<div class="console-it"><h6>')
            html.push(_message(msg));
            html.push(':</h6>');
